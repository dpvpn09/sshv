...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/dpvpn09/sshv/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/dpvpn09/sshv/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/dpvpn09/sshv/main/wireguard/renewwg.sh"
wget https://raw.githubusercontent.com/dpvpn09/sshv/main/wireguard/xpwg
chmod +x addwg
chmod +x delwg
chmod +x renewwg
chmod +x xpwg
