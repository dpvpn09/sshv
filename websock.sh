...
# Install Template
wget -q -O /usr/local/bin/ws-drop "https://raw.githubusercontent.com/dpvpn09/sshv/main/ws-dropbear.py"
wget -q -O /usr/local/bin/ws-openssh "https://raw.githubusercontent.com/dpvpn09/sshv/main/ws-openssh.py"
wget -q -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/dpvpn09/sshv/main/ws-ovpn.py"
wget -q -O /usr/local/bin/ws-tls "https://raw.githubusercontent.com/dpvpn09/sshv/main/ws-tls.py"
