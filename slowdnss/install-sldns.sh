...
#wget -qc https://raw.githubusercontent.com/dpvpn09/sshv/main/slowdnss/dns.sh && chmod +x dns.sh &&  sed -i -e 's/\r$//' dns.sh && ./dns.sh
nameserver=$(cat /home/nsdomain)
echo -e "[ ${green}INFO${NC} ] Download File... "
echo "Progress..." | lolcat
# SSH SlowDNS
echo -e " [ ${green}INFO${NC} ] Successfully.. "
wget -qO- -O /etc/ssh/sshd_config https://raw.githubusercontent.com/dpvpn09/sshv/main/slowdnss/sshd_config
...
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading files... "
wget -qc -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/dpvpn09/sshv/main/slowdnss/sldns-server"
wget -qc -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/dpvpn09/sshv/main/slowdnss/sldns-client"
sleep 1
