...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/dpvpn09/sshv/main/password"
...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/dpvpn09/sshv/main/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/dpvpn09/sshv/main/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/dpvpn09/sshv/main/squid3.conf"
...
#Forward 443 = ws
wget -O /etc/default/sslh "https://raw.githubusercontent.com/dpvpn09/sshv/main/sslh.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/dpvpn09/sshv/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/dpvpn09/sshv/main/bannerssh.conf"
