...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/dpvpn09/sshv/main/ipsec/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/dpvpn09/sshv/main/ipsec/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/dpvpn09/sshv/main/ipsec/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/dpvpn09/sshv/main/ipsec/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/dpvpn09/sshv/main/ipsec/delpptp.sh && chmod +x /usr/bin/delpptp
